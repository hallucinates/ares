                ...
                <div class="modal-content pt-5 pb-4" style="border-radius:20px">
                    <form method="POST" action="{{ url('testimoni/'.$pesanan->kode) }}">
                        ...
                        <div class="containerRate">
                            ...
                            <div class="emoji">
                                <input type="hidden" name="ulasan" id="ulasan" class="emoji-radio">
                                <div class="row">
                                    <div class="col-lg">
                                        <button type="submit" class="btnYellowPrimary w-100 py-4">Mantap</button>
                                    </div>
                                    <div class="col-lg">
                                        <button type="submit" class="btnYellowPrimary w-100 py-4">Cepatr3aaz</button>
                                    </div>
                                </div>
                            ...
                            <div class="floating-label-content mb-lg-3 mb-md-2">
                                <textarea class="form-control floating-input" name="ulasan2" id="ulasan2" placeholder=" " style="min-height:140px"></textarea>
                    ...
                    <table class="table">
                        ...
                        <tr class="text-dark">
                            ...
                            <td style="white-space: nowrap;">
                                <span class="{{ App\Helper::statusPesanan($status_pt)['color'] }}">{{ App\Helper::statusPesanan($status_pt)['status'] }}</span>                    
                            </td>
                        </tr>
                        @empty
                        <tr>
